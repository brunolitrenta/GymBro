...
const AddWorkoutModal = () => {
    ...
    return (
        <View className='flex-1 justify-center items-center'>
            ...
            <View className='w-1/2 h-1/4 bg-primary rounded-3xl absolute top-[10%] left-[45%] items-center justify-evenly shadow-lg'>
                ...
                <Pressable onPress={() => confirmeRemoval()} className='flex-row w-full h-1/2 justify-around items-center rounded-b-2xl active:bg-grayish'>
                    <View className='w-4/5 justify-around flex-row'>
                        <FontAwesome6 name="trash" size={24} color="black" />
                        <Text className='font-rsemi text-xl w-4/6 text-center'>Remover</Text>
                    </View>
                </Pressable>
            </View>
        </View>
